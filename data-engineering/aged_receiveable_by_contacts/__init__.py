...
from aged_receiveable_by_contacts.aged_receiveable_by_contacts import insert_aged_receiveable_by_contact_data
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    is_response = insert_aged_receiveable_by_contact_data(token, tenant, xero_userid, conn, user_id)
    conn.close()
